...
The main remaining reproducibility work is publishing the audited retrieval
materializer, generation/scoring orchestration and selector training entry
point, followed by an independent complete benchmark replay. New components
need documented parameters and tests; a download link alone is not a runnable
